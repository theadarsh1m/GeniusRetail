...
import { getRestockingSuggestions, type GetRestockingSuggestionsOutput } from "@/ai/flows/restocking-suggestions";
...
export default function AdminPage() {
  ...
  const [suggestions, setSuggestions] = useState<GetRestockingSuggestionsOutput>([]);
  ...
  return (
    <div className="container mx-auto space-y-8">
      <div>
        <h1 className="text-4xl font-bold font-headline">Inventory Intelligence</h1>
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Live overview of all product stock. Items with less than 10 units are marked.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
        ...
        <div className="space-y-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Use Gemini AI to analyze sales trends and suggest optimal restocking quantities for low-stock items.
              </CardDescription>
            </CardHeader>
            <CardContent>
